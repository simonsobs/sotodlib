...
# If no config file is provided, the following defaults are assumed
...
parser.add_argument("query", type=str, default=cfg['query'])
parser.add_argument("freq", type=str, default=cfg['freq'])
parser.add_argument("area", type=str, default=cfg['area'])
parser.add_argument("odir", type=str, default=cfg['odir'])
parser.add_argument("prefix", type=str, default=cfg['prefix'],
                    nargs="?")
parser.add_argument("-C", "--comps",   type=str, default=cfg['comps'], help="T,Q, and/or U")
parser.add_argument("-c", "--context", type=str, default=cfg['context'], help="Context containing TODs")
parser.add_argument("-n", "--ntod",    type=int, default=cfg['ntod'])
parser.add_argument(      "--tods",    type=str, default=cfg['tods'])
parser.add_argument(      "--nset",    type=int, default=cfg['nset'])
parser.add_argument("-N", "--nmat",    type=str, default=cfg['nmat'])
parser.add_argument(      "--max-dets",type=int, default=cfg['max-dets'])
parser.add_argument("-S", "--site",    type=str, default=cfg['site'])
parser.add_argument("-v", "--verbose", action="count", default=cfg['verbose'])
parser.add_argument("-q", "--quiet",   action="count", default=cfg['quiet'])
parser.add_argument("-@", "--center-at", type=str, default=cfg['center-at'])
parser.add_argument("-w", "--window",  type=float, default=cfg['window'])
parser.add_argument("-i", "--inject",  type=str, default=cfg['inject'])
parser.add_argument(      "--nocal",   action="store_true", default=cfg['nocal'])
parser.add_argument(      "--nmat-dir", type=str, default=cfg['nmat-dir'])
...
parser.add_argument("-W", "--wafer"  ,   type=str, default=cfg['wafer'], nargs='+', help="Detector wafer subset to map with")
