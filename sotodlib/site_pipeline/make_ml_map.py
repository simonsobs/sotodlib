...
def get_parser(parser=None):
    ...
    parser.add_argument("-n", "--ntod",    type=int)
    parser.add_argument(      "--tods",    type=str)
    parser.add_argument(      "--nset",    type=int)
    parser.add_argument("-N", "--nmat",    type=str)
    ...
    parser.add_argument(      "--nocal",   action="store_true", default=True)
    parser.add_argument(      "--nmat-dir", type=str)
