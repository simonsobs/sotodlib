...
def parse_args():
    ...
    parser.add_argument('-a', '--array-name',help=
                        "Array name to generate the DetDb.")
...
def main(args=None):
    ...
    logger.info(f"Creating DetDb for UFM-{args.array_name}")
    array_name = args.array_name

    if args.out_file is None:
        out_file = f"{args.array_name}_detdb.db"
        out_dir = '.'
        out_path = out_file
    else:
