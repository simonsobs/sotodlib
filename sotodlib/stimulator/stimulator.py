...
def get_fit_params(cal_type):
    ...
    if cal_type == 'gain':
        ...
        params_base.add('a0',value=1e-3,min=0,max=1e-1)
        params_base.add('a1',value=2e-4,min=0,max=1e-2)
        params_base.add('a2',value=2e-4,min=0,max=1e-2)
        params_base.add('a3',value=1e-4,min=0,max=1e-2)
        params_base.add('a4',value=1e-4,min=0,max=1e-2)
        params_base.add('a5',value=1e-5,min=0,max=1e-3)
        params_base.add('a6',value=1e-5,min=0,max=1e-3)
        ...
        params_base['fit_coadd'].add('a0',value=1e-3,min=0,max=1)
        params_base['fit_coadd'].add('a1',value=2e-4,min=0,max=1)
        params_base['fit_coadd'].add('a2',value=2e-4,min=0,max=1)
        params_base['fit_coadd'].add('a3',value=1e-4,min=0,max=1)
        params_base['fit_coadd'].add('a4',value=1e-4,min=0,max=1)
        params_base['fit_coadd'].add('a5',value=1e-5,min=0,max=1)
        params_base['fit_coadd'].add('a6',value=1e-5,min=0,max=1)
