...
def calc_Dw_from_IAU_report(planet, timestamp):
    ...
    if planet == 'mercury':
        ...
        W = 329.5469 + 6.1385025*d + 0.00993822*sin(d2r(M1)) + 0.00104581*sin(d2r(M2)) + 0.00009431*sin(d2r(M3)) + 0.00000790*sin(d2r(M4)) + 0.00000071*sin(d2r(M5))
    ...
    if planet == 'mars':
        alpha = 317.269202 - 0.10927547*T + 0.000068*sin(d2r(198.991226 + 19139.4819985*T)) + 0.000238*sin(d2r(226.292679 + 38280.8511281*T)) + 0.000052*sin(d2r(249.663391 + 57420.7251593*T)) + 0.000009*sin(d2r(266.183510 + 76560.6367950*T)) + 0.419057*sin(d2r(79.398797 + 0.5042615*T))
        delta = 54.432516 - 0.05827105*T + 0.000051*cos(d2r(122.433576 + 19139.9407476*T)) + 0.000141*cos(d2r(43.058401 + 38280.8753272*T)) + 0.000031*cos(d2r(57.663379 + 57420.7517205*T)) + 0.000005*cos(d2r(79.476401 + 76560.6495004*T)) + 1.591274*cos(d2r(166.325722 + 0.5042615*T))
        W = 176.049863 + 350.891982443297*d + 0.000145*sin(d2r(129.071773 + 19140.0328244*T)) + 0.000157*sin(d2r(36.352167 + 38281.0473591*T)) + 0.000040*sin(d2r(56.668646 + 57420.9295360*T)) + 0.000001*sin(d2r(67.364003 + 76560.2552215*T)) + 0.000001*sin(d2r(104.792680 + 95700.4387578*T)) + 0.584542*sin(d2r(95.391654 + 0.5042615*T))
