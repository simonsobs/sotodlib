...
setup_opts["entry_points"] = {
    "console_scripts": [
        ...
        "toast_so_sim = sotodlib.workflows.toast_so_sim:cli",
        "toast_so_map = sotodlib.workflows.toast_so_map:cli",
        "toast_so_convert = sotodlib.workflows.toast_so_convert:cli",
        "get_wafer_offset = sotodlib.workflows.get_wafer_offset:main",
    ]
}
